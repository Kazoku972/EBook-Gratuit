    ...
    return (
        <div ref={containerRef} className="flex justify-center items-center w-full min-h-screen h-dvh transition-colors duration-500 overflow-hidden relative">
            ...
            >
                ...
                {/* PAGE 3: CITATION */}
                <Page number="3" isDarkMode={isDarkMode} centered viewportHeight={dimensions.height}>
                ...
                {/* PAGE 5: RAPPEL */}
                <Page number="5" isDarkMode={isDarkMode} centered viewportHeight={dimensions.height}>
